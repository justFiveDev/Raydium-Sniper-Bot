import { Idl as Coral_xyz_idl } from "@coral-xyz/anchor";
import { Idl as Serum_idl } from "@project-serum/anchor";

export type RaydiumCpmm = {
...
export const RAYDIUM_CPMM_IDL: Coral_xyz_idl = {
  address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C",
  metadata: {
    ...
    spec: "0.1.0",
    description:
      "Raydium constant product AMM, supports Token2022 and without Openbook",
  },
  instructions: [
    {
